...
Built an interactive Power BI dashboard to analyze bank-wise ATM, POS, and card transaction statistics from 2022 onwards.
2023 has the highest ATM withdrawals in the dataset.
...
The growth of online debit and credit card transactions reflects the rising popularity of e-commerce and digital services.
Banks with larger POS networks generate higher digital transactions
There is a clear relationship between POS infrastructure and digital payment volume, where banks with more POS machines tend to process higher transaction volumes.
